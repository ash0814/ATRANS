...
<kbd> <img width=600 src="./pic/main.PNG" /> </kbd>

### 2. 변환기 설정

- `Add Transformer` 버튼 클릭 <br>
  <kbd> <img width=600 src="./pic/addbunClick.png" /> </kbd>
- 변환기 설정 창<br>
  <kbd><img width=600 src="./pic/그림2.png"/></kbd>
...
- 변환기 설정 완료<br>
  <kbd><img width=600 src="./pic/4.PNG" /> </kbd>
  - 변환기를 추가하면 타일이 추가된다,
...
- 'START' 클릭<br>
  <kbd><img width=600 src="./pic/start.png" /> </kbd>

- 스레드 작업 시작<br>
  <kbd><img width=600 src="./pic/image-4.png" /> </kbd>
  - 변환기에 설정한 스레드가 작업을 시작한다.<br>
    <kbd><img width=600 src="./pic/스레드2.PNG" /> </kbd>
    - 스레드를 3개 미만으로 설정했을 때에는 사용하지 않는 스레드는 `THREAD NOT WORKING`으로 표시된다.

### 4. 파일 입력

- 설정한 입력 경로에 파일을 추가한다.
  <br><kbd><img width=600 src="./pic/folder.PNG" /> </kbd>
...
- 파일 변환 실행<br>
  <kbd><img width=600 src="./pic/Inprogress.PNG" /> </kbd>
...
- 오류 리스트 확인<br>
  <kbd><img width=600 src="./pic/그림4.png" /> </kbd>

  - 실패(오류) 카운트 숫자를 클릭하여 에러 리스트를 새로운 창에서 확인할 수 있다.<br>
  <kbd><img width=600 src="./pic/errorList.PNG" /> </kbd>
...
### 5. 프로그램 중지
<br>
<kbd><img width=600 src="./pic/stop.png" /> </kbd>

- `FINISH` 버튼 혹은 상단 `x` 버튼을 통해 프로그램을 종료시킬 수 있다.<br>
  <kbd><img width=300 src="./pic/warn.PNG" /> </kbd>
...
<br>
<kbd><img width=600 src="./pic/prev.png" /> </kbd>
